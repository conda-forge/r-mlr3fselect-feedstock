...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/r-mlr3fselect-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/r-mlr3fselect-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add r-mlr3fselect
# for installing globally
pixi global install r-mlr3fselect
```
...
It is possible to list all of the versions of `r-mlr3fselect` available on your platform:
...
```
pixi search r-mlr3fselect --channel conda-forge
```
